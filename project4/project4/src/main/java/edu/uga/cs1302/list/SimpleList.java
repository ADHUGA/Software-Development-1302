 ...
 * last element is at position list.size() minus 1.
 */
public interface SimpleList<E> {
     ...
     * @param e the element to be added to the list.
     * @return true
     * throws IndexOutOfBoundsException if the index out of range, i.e. index less than 0 or index greater than or equal to the size().
     */
     ...
     * or negative 1 if the given element is not on the list.  If the argument element is null,
     * the method returns the index of the first null elment on the list, or negative 1 if the list
     ...
     * or negative 1 if the given element is not on the list.
     */
